							...
							<div class="container">
								<div class="row">
									<div class="col-lg-9">
										<div class="row">
											<div class="room"
												onclick="location.href='/petsit/myPage/petsitter/petsit/petsitDetail.jsp';">
											...
											<div class="room"
												onclick="location.href='/petsit/myPage/petsitter/petsit/petDetail.jsp';">
												<div class="text p-3 text-center">
											...
											<div class="room"
												onclick="location.href='/petsit/myPage/petsitter/pestit/petDetail.jsp';">
												<div class="text p-3 text-center">
