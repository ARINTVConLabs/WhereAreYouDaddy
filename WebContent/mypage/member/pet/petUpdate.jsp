						...
						<div class="col-md-6">
							<div class="col-md-12">
								<form class="form" action="" method="post">
									<h3 class="text-center">반려동물 정보수정</h3>
									<br>
									...
									<div>
										<input type="submit" value="수정" class="btn btn-secondary py-2 px-5" onClick="location.href='/petsit/myPage/member/pet/petList.jsp'"> 
										<input type="reset" value="초기화" class="btn btn-secondary py-2 px-5"> 
										<input type="button" value="취소" onClick="location.href='/petsit/myPage/member/pet/petList.jsp'" class="btn btn-secondary py-2 px-5">
									</div>
								</form>
							</div>
						</div>
